...
(function(){
    ...
    this.stackedCards = (function() {
        ...
        stackedCards.prototype.slideChange = function(me, els, activeTransform) {
            var clickedEl = els[this.slideindex];
            var nextCnt = 0;
            var prevCnt = 0;
            ...
            els[this.slideindex].classList.add("active");
            els[this.slideindex].classList.add(me.config.layout);

            els[this.slideindex].style.zIndex = els.length*5;
            els[this.slideindex].style.transform = activeTransform;

            if(this.slideindex == els.length - 1){
                this.flag = false;
            }
        ...
        stackedCards.prototype.draw = function () {
            ...
            var firstslide = this.config.firstslide;
            ...
            var getItemHeight = els[0].clientWidth - 50;
            ...
            if(this.config.automatic){
                this.slideindex = 0;
                this.flag = true;
                setInterval(function(){ me.slideChange(me, els, activeTransform) }, 3000);
            }
                ...
                el.addEventListener("click", function() {
                    ...
                    Array.prototype.forEach.call(els, function(el) {
                        if(el.classList.contains('active'))
                            buttonHTML += "<li class = 'selected'>•</li>";                
                        else
                            buttonHTML += "<li>•</li>";
                    });
        
                    if(document.getElementsByClassName('buttons')[0] !== undefined)
                        document.getElementsByClassName('buttons')[0].innerHTML = buttonHTML;
                    ...
                    Array.prototype.forEach.call(buttons, function(button, index) {
                        button.addEventListener("click", function(){
                            ...
                            els[index].classList.add(me.config.layout)
                            ...
                            els[index].style.zIndex = els.length*5;
                            els[index].style.transform = activeTransform;
                        });
                    });
        ...
        stackedCards.prototype.reCalculateTransformsOnClick = function(nextCnt, prevCnt) {
            ...
            if(screen.width < 600){
                if(els.length <= 7){
                    scale = 1 - 0.4 / maxCntDivisor * (prevCnt + 1);
                }else{
                    scale = 1 - 0.1 * (prevCnt + 1);
                }
                var dist = 13;
                translateX = -50;
        ...
        stackedCards.prototype.detectSwipeDir = function(el, callback) {
            ...
            touchsurface.addEventListener('touchend', function(e){
                ...
                if(touchobj.target.classList.contains('active'))
